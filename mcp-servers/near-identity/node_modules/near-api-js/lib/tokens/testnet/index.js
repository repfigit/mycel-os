...
export const wNEAR = new FungibleToken('wrap.testnet', {
...
export const USDC = new FungibleToken('usdc.fakes.testnet', {
    name: 'USDC',
    decimals: 6,
    symbol: 'USDC',
...
export const USDT = new FungibleToken('usdt.fakes.testnet', {
    name: 'Tether USD',
    decimals: 6,
    symbol: 'USDt',
