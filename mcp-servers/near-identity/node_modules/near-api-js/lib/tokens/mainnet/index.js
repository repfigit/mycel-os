...
export const wNEAR = new FungibleToken('wrap.near', {
...
export const USDC = new FungibleToken('17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1', {
    name: 'USDC',
    decimals: 6,
    symbol: 'USDC',
...
export const USDT = new FungibleToken('usdt.tether-token.near', {
    name: 'Tether USD',
    decimals: 6,
    symbol: 'USDt',
